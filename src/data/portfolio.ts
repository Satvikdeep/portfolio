...
export const projects: Project[] = [
    ...
    {
        name: "Optimized Spell \nChecker Engine",
        tech: "C++ · Trie · Dynamic Programming",
        desc: "Built a real-time C++ engine featuring a Trie-based dictionary for rapid word verification, and calculated Levenshtein distance via Dynamic Programming for intelligent spelling suggestions.",
        img: "#",
        link: "https://github.com/Satvikdeep",
        github: "https://github.com/Satvikdeep",
        hasPreview: false,
    },
    {
        name: "Medical Image Denoising Pipeline",
        tech: "Python · TensorFlow · CNN · Autoencoder",
        desc: "Built a 6-layer Convolutional Autoencoder using TensorFlow to denoise 2,000+ medical scans, reducing 25% Gaussian noise and achieving a Peak Signal-to-Noise Ratio (PSNR) of 28 dB.",
        img: "#",
        link: "https://github.com/Satvikdeep",
        github: "https://github.com/Satvikdeep",
        hasPreview: false,
